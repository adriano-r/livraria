...
class ReservaService {
	...
	const DEFAULT_INSTANCE = 'reserva-cart';
	 ...
	 * @return void
	 */
	public function add($id, $titulo, $disponivel, $quantity, $options = []): void
	{
		$cartItem = $this->createCartItem($titulo, $disponivel, $quantity, $options);
	...
	public function total(): string
	{
		...
		$total = $content->reduce(function ($total, $item) {
			return $total += $item->get('disponivel') - $item->get('quantity');
		});
	 ...
	 * @return Illuminate\Support\Collection
	 */
	protected function createCartItem(string $titulo, string $disponivel, string $$quantity, array $options): Collection
	{
